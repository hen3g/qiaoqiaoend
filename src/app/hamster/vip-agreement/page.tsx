...
const VIP_PAGE_URL =
  "https://qiaoqiaoengapp.word19.com/hamster/vip-agreement";
...
const COPY = {
  ...
  ja: {
    ...
    title: "会員サービス規約",
    lead:
      "本規約は、言词科技（大连）有限公司（以下「当社」）とお客様との間で、「倉鼠単語」VIP 会員サービスについて定めるものです。ご契約または更新の前に必ずお読みください。同意へのタップ・チェック、または支払い完了により、本規約を読み同意したものとみなされます。同意できない場合は、購入または更新を行わないでください。",
    s1Title: "1. サービス内容",
    s1Body1:
    ...
    s2Items: [
      ...
      "Android では現在、主に Alipay（支付宝）による一括購入です。会員期間は支払い成功時から起算し、繰り返し購入して有効期間を加算できます。",
    ...
    s5Items: [
      ...
      "Android の Alipay 決済で、システム障害による二重課金や契約未完了等があった場合、確認のうえ対応します（特典の再付与、または元の経路での返金等）。",
    ],
    s6Title: "6. 利用規範と停止",
    s6Body:
          ...
          <ContactBlock
            ...
            extra={
              <>
                ...
                {c.vipPageLabel}：
                <a href={VIP_PAGE_URL}>
                  qiaoqiaoengapp.word19.com/hamster/vip-agreement
                </a>
              </>
            }
          />
