    ...
    <CompanyShell hideChrome>
      <article className={styles.legal}>
        ...
        <p className={styles.legal__lead}>
          本协议是你与言词科技（大连）有限公司（下称「我们」）之间，就「仓鼠单词」VIP
        ...
        <section>
          ...
          <p>
            VIP
            会员是我们向付费用户提供的增值学习服务。开通后，你可以在会员有效期内使用当时产品界面展示的会员权益（包括但不限于自制词库、更高练习额度、会员钻石礼包等）。权益内容可能随产品迭代调整，以购买时及 App
            内公示为准。
          </p>
          <p>
            个人信息处理规则见
            <Link href="/hamster/privacy">《隐私政策》</Link>
            ；一般使用规则见
            <Link href="/hamster/terms">《用户协议》</Link>。
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            <br />
            会员服务协议页面：
            <a href="https://qiaoqiaoengapp.word19.com/hamster/vip-agreement">
