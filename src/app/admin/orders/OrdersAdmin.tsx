...
export function OrdersAdmin() {
  ...
  const loadOrders = useCallback(async () => {
    ...
    try {
      ...
      if (channel === "apple") {
        ...
        const res = await fetch(`/api/admin/apple-orders?${params.toString()}`);
  ...
  const appleColumns: ColumnProps<AdminAppleOrder>[] = [
    {
      title: "Apple 交易号",
      width: 240,
      render: (_, o) => (
    ...
    },
    {
      ...
      width: 100,
      render: (_, o) => (
        <Tag color={o.environment === "Sandbox" ? "orangered" : "green"}>
          {o.environment === "Sandbox" ? "沙盒" : "正式"}
        </Tag>
      ),
    },
    {
