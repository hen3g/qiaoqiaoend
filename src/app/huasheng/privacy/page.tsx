    ...
    <CompanyShell hideChrome>
      <article className={styles.legal}>
        ...
        <p className={styles.legal__lead}>
          本政策适用于言词科技（大连）有限公司（下称「我们」）运营的英语学习软件「花生英语」、网站（yancilanguage.cn）及相关账号服务。使用我们的产品或网站即表示你已阅读并理解本政策。若你不同意，请停止使用。
        </p>
        ...
        <section>
          ...
          <p>
            ...
            <br />
            App 隐私政策页面：
            <a href="https://qiaoqiaoengapp.word19.com/huasheng/privacy">
              qiaoqiaoengapp.word19.com/huasheng/privacy
            </a>
            <br />
            邮箱：
            <a href="mailto:baseheng@qq.com">baseheng@qq.com</a>
