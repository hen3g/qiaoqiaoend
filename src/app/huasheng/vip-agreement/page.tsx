...
export const metadata: Metadata = {
  title: "花生英语会员服务协议",
  description:
    "花生英语会员服务协议：说明 VIP 会员权益、付费规则、自动续费与退款等事项。",
};
    ...
    <CompanyShell hideChrome>
      <article className={styles.legal}>
        ...
        <p className={styles.legal__lead}>
          本协议是你与言词科技（大连）有限公司（下称「我们」）之间，就「花生英语」VIP
        ...
        <section>
          ...
          <p>
            个人信息处理规则见
            <Link href="/huasheng/privacy">《隐私政策》</Link>
            ；一般使用规则见
            <Link href="/huasheng/terms">《用户协议》</Link>。
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            <br />
            会员服务协议页面：
            <a href="https://qiaoqiaoengapp.word19.com/huasheng/vip-agreement">
              qiaoqiaoengapp.word19.com/huasheng/vip-agreement
            </a>
            <br />
            邮箱：
