...
export const metadata: Metadata = {
  title: "花生英语用户指南",
  description:
    "花生英语用户指南：看中文、听发音、自己敲出英文。闯关、系列课程、每日一课、自制课程与生词复习。",
};
    ...
    <CompanyShell hideChrome>
      <article className={styles.legal}>
        ...
        <p className={styles.legal__lead}>
          「花生英语」是打字练习：先看中文提示、听标准读音，再亲手把单词或整句敲出来。系统即时纠错。它不是选择题 App。仓鼠单词请看
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              开通前请阅读
              <Link href="/huasheng/vip-agreement">《会员服务协议》</Link>。
            </li>
          </ul>
        </section>
